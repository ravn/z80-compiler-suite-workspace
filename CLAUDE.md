...
Current: Clang 1777 bytes vs SDCC 1910 bytes (-7.0%) for the autoload PROM. BIOS: Clang 5742B (with memcpy_z80 scroll + sentinel). Clang is smaller. (IX/IY reverted to reserved — allocation was incomplete, #38.)
