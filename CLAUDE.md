...
Current: Clang 1876 bytes vs SDCC 1910 bytes (-1.8%) for the autoload PROM. Clang is still smaller. (+undocumented enabled; IX constant propagation folds sub-reg extractions.)
