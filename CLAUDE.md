...
Current: Clang 1842 bytes vs SDCC 1910 bytes (-3.6%) for the autoload PROM. BIOS: Clang 5742B (with memcpy_z80 scroll + sentinel). Clang is smaller. (IX/IY reverted to reserved — allocation was incomplete, #38.)
